...
// Lab 하위 페이지 공통 레이아웃 (콘텐츠는 children으로 채움)
export function LabPageShell({ href, strategy, title, children }: LabPageShellProps) {
	const route = getLabRoute(href);
	const { prev, next } = getLabNeighbors(href);
	...
	return (
		<div className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
			...
			<nav
				...
				aria-label="Lab page navigation"
			>
				{prev ? (
					<Link
						href={prev.href}
